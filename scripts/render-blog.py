...
@media(max-width:860px){{nav{{padding:0 20px;background:rgba(14,18,53,.92);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);border-bottom:1px solid rgba(240,239,233,.06)}}.nav-links{{display:none}}.nav-social,.nav-login{{display:none}}.lang-sel{{display:none}}.nav-right{{display:none}}.nav-ham{{display:flex}}.nav-book{{display:inline-flex;margin-left:auto;margin-right:12px}}.hero-banner{{height:320px;margin-top:0}}.hero-overlay{{bottom:28px;padding:72px 24px 0}}.breadcrumbs{{padding:0 20px;margin-top:12px;font-size:.68rem}}.article{{padding:16px 20px 72px}}.article-meta{{margin-bottom:20px}}footer{{padding-left:24px;padding-right:24px}}.ft-in{{grid-template-columns:1fr 1fr}}}}
