# What Is Breathwork? A No-Nonsense Guide for the Curious and Sceptical
...
Breathwork techniques that alter blood chemistry should be avoided by:

- Pregnant people
- Anyone with cardiovascular conditions (including uncontrolled high blood pressure)
- People with epilepsy
- Anyone in the acute phase of a psychiatric condition

Calming breathwork (slow, gentle techniques) is safe for nearly everyone. If in doubt, mention any health conditions to the facilitator before the session.

---

## The immersive difference
...
## Breathwork techniques you'll encounter

**Box breathing (4-4-4-4):** Inhale 4 counts, hold 4, exhale 4, hold 4. Military-origin. Good for acute stress.

**Coherence breathing (5-5):** 5-second inhale, 5-second exhale. Synchronises heart rate with breath rate. The most studied calming technique.

**Cyclic sighing:** Extended exhale with a double inhale (in-in-out). The Stanford technique. Specifically good for mood improvement.
